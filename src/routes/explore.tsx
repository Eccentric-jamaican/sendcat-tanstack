...
import { featuredCards, categories, shopSections } from '../data/explore'
          ...
          <section className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {featuredCards.map((card, idx) => (
              <motion.div
                ...
                className={cn(
                  "group relative rounded-[32px] overflow-hidden cursor-pointer shadow-xl shadow-black/5",
              ...
              >
                ...
                <div className="absolute top-6 left-6 right-6 flex justify-between items-start">
                  ...
                  <div className={cn(
                    "w-10 h-10 rounded-full bg-white/10 backdrop-blur-md border border-white/10 flex items-center justify-center text-white transition-opacity",
            ...
            <section key={section.id} className="space-y-6">
              ...
              <div className="flex gap-4 overflow-x-auto pb-6 scrollbar-hide -mx-4 px-4 md:mx-0 md:px-0 scroll-pl-4">
                {section.items.map((item) => (
                  <div key={item.id} className="flex-none w-[160px] md:w-[220px] group cursor-pointer">
